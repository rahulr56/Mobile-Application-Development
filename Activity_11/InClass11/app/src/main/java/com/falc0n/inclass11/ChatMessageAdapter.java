...
public class ChatMessageAdapter extends ArrayAdapter<ChatMessage>{
    ...
    public ChatMessageAdapter(Context context, int resource, ArrayList<ChatMessage> msgist) {
        super(context, resource, msgist);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView imageView = (ImageView) convertView.findViewById(R.id.imageViewRVIcon);
        TextView textView = (TextView) convertView.findViewById(R.id.textViewRVName);
